...
document.addEventListener('DOMContentLoaded', function() {
    const StockManager = {
        ...
        populateGridView() {
            ...
            gridContainer.innerHTML = this.inventory.map(item => `
                <div class="grid-item" data-item-id="${item.id}">
                    ...
                    <div class="grid-item-content">
                        ...
                        <p class="item-location">${item.location || 'Unknown'}</p>
                        <p class="item-supplier">${item.supplier || 'N/A'}</p>
                    </div>
                    <div class="grid-item-actions">
                        <button class="action-btn primary sm" onclick="StockManager.showOrderModal(${item.id})">
                            <i class="fas fa-shopping-cart"></i>
                        </button>
                        <button class="action-btn secondary sm" onclick="StockManager.editItem(${item.id})">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="action-btn danger sm" onclick="StockManager.removeItem(${item.id})">
                            <i class="fas fa-trash"></i>
                        </button>
                    </div>
                </div>
